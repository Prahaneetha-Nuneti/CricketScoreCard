...
var table = /** @class */ (function () {
    ...
    table.prototype.create = function (id) {
...
var z1 = document.createElement("z1");
z1.innerHTML = "<h5>TEAM 1 SCORE</h5>";
z.appendChild(z1);
var z2 = document.createElement("z1");
...
for (var i = 1; i <= 6; i++) {
    var z_1 = "tb1_0" + i.toString();
    document.getElementById(z_1).innerHTML = "B" + i.toString();
}
for (var i = 1; i <= 10; i++) {
    var z_2 = "tb1_" + i.toString() + "0";
    document.getElementById(z_2).innerHTML = "PLAYER " + i.toString();
}
document.getElementById("tb2_00").innerHTML = "TEAM 2";
document.getElementById("tb2_07").innerHTML = "TOTAL";
for (var i = 1; i <= 6; i++) {
    var z_3 = "tb2_0" + i.toString();
    document.getElementById(z_3).innerHTML = "B" + i.toString();
}
for (var i = 1; i <= 10; i++) {
    var z_4 = "tb2_" + i.toString() + "0";
    document.getElementById(z_4).innerHTML = "PLAYER " + i.toString();
}
var timeleft = 60;
